...
#    define PLATFORM_BYTE_ORDER SHA_BIG_ENDIAN
#  endif
#elif defined(__BYTE_ORDER__) && (defined (__ORDER_LITTLE_ENDIAN__) || defined (__ORDER_BIG_ENDIAN__) )  /* GCC */
#  if __BYTE_ORDER__ == __ORDER_LITTLE_ENDIAN__
#     define PLATFORM_BYTE_ORDER SHA_LITTLE_ENDIAN
#  elif __BYTE_ORDER__ == __ORDER_BIG_ENDIAN_
#     define PLATFORM_BYTE_ORDER SHA_BIG_ENDIAN
#  endif
#elif defined __LITTLE_ENDIAN__ || defined __BIG_ENDIAN__ /* IAR */

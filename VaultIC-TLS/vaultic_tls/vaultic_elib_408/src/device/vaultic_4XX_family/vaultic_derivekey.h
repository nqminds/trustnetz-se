...
*
* @brief Auxiliary functions for key derivation.
*
* @par Description:
* This file declares functions for key derivation.
*/

#ifndef VAULTIC_DERIVEKEY_H
#define VAULTIC_DERIVEKEY_H

#include "vaultic_typedefs.h"

/**
 * \brief Derive a key using the hashMode algorithm
 * \par Description
 * See VltDeriveKey().
 */
...
/**
 *
 * \brief Derive a key using the concatenation (NIST) algorithm
 * \par Description
 * See VltDeriveKey().
 */
...
/**
 *
 * \brief Derive a key using the X963 algorithm
 * \par Description
 * See VltDeriveKey().
 */
